...
// 官网的开发服务器选项: https://cn.vitejs.dev/config/server-options.html
// dev
cli // [] 为选填, <> 为必填
  ...
  .option('--strictPort', `[boolean] exit if specified port is already in use`) // 如果指定端口号则退出
  .option(
    '--force',
...
// 官网的构建选项: https://cn.vitejs.dev/config/build-options.html
// build
cli
...
// 官网的依赖优化选项: https://cn.vitejs.dev/config/dep-optimization-options.html
// optimize
cli
...
// 官网的预览选项: https://cn.vitejs.dev/config/preview-options.html
// preview
cli
